...
if (event.currentSlide.id === 'ppascending1') {
  if (ppascending1 == undefined) {
    ppascending1 = new Vivus('ppascending1-anim', { type: 'oneByOne', duration: 450, animTimingFunction: Vivus.LINEAR, file: 'images/graphs/ascending7.svg', reverseStack: false });
  } else {
...
if (event.currentSlide.id === 'reducedbot2') {
  if (reducedbot2 == undefined) {
    reducedbot2 = new Vivus('reducedbot2-anim', { type: 'oneByOne', duration: 300, animTimingFunction: Vivus.LINEAR, file: 'images/graphs/bottom3-anim-2.svg', reverseStack: false });
  } else {
...
if (event.currentSlide.id === 'reducedbot3') {
  if (reducedbot3 == undefined) {
    reducedbot3 = new Vivus('reducedbot3-anim', { type: 'oneByOne', duration: 300, animTimingFunction: Vivus.LINEAR, file: 'images/graphs/bottom3-anim-3.svg', reverseStack: false });
  } else {
...
if (event.currentSlide.id === 'reducedascending0') {
  if (reducedascending0 == undefined) {
    reducedascending0 = new Vivus('reducedascending0-anim', { type: 'oneByOne', duration: 300, animTimingFunction: Vivus.LINEAR, file: 'images/graphs/ascending4-v1.svg', reverseStack: false });
  } else {
...
if (event.currentSlide.id === 'reducedascending1') {
  if (reducedascending1 == undefined) {
    reducedascending1 = new Vivus('reducedascending1-anim', { type: 'oneByOne', duration: 300, animTimingFunction: Vivus.LINEAR, file: 'images/graphs/ascending10.svg', reverseStack: false });
  } else {
